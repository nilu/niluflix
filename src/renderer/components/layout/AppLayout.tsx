          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <button
              className={`px-3 py-2 rounded-md transition-colors cursor-pointer ${
                location.pathname === '/movies' ? 'text-white bg-white/10' : 'text-gray-300 hover:text-white hover:bg-white/5'
              }`}
            ...
            <Link 
              to="/library" 
              className={`transition-colors ${
                location.pathname === '/library' ? 'text-white' : 'text-gray-300 hover:text-white'
              }`}
            >
              My Library
            </Link>
